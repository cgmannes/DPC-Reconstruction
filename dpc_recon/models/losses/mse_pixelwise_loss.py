...
from mmgen.models.losses.pixelwise_loss import mse_loss as mmgen_mse_loss


@MODULES.register_module()
class S2DMSELoss(MSELoss):
    """MSE loss based on Sparse2Dense: Learning to Densify 3D Features.
    ...
    """
    def __init__(self, reduction, beta, gamma, *args, **kwargs):
    ...
    def forward(self, *args, **kwargs):
        ...
        if self.data_info is not None:
            ...
            mse_loss = beta_loss + gamma_loss
            return mse_loss, heatmap_masks
        else:
