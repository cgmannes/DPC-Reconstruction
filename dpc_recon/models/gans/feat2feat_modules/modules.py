...
from mmgen.models.architectures.pix2pix import UnetSkipConnectionBlock as Pix2PixUnetSkipConnectionBlock


@MODULES.register_module()
class Feat2FeatUnetSkipConnectionBlock(Pix2PixUnetSkipConnectionBlock):
    ...
    def __init__(self,
        ...
        kernel_size = 4 if kernel_size is None else kernel_size
        stride = 2 if stride_size is None else stride_size
        padding = 1 if padding_size is None else padding_size
        ...
        if is_outermost:
            ...
            up_bias = True
            up_norm_cfg = None
            '''Modified upper from nn.tanh() to nn.ReLU'''
            upper = [nn.ReLU()]
        elif is_innermost:
            down_norm_cfg = None
